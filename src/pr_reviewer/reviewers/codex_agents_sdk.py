...
def _run_agents_codex_review_sync(
    ...
    prompt = (
        ...
        "### Findings\n"
        "Severity: P1 = breaks production / data loss / security vulnerability, "
        "P2 = logic error / correctness issue causing user-facing misbehavior, "
        "P3 = code quality / style / low-risk concern.\n"
